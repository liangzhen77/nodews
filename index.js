...
const UUID = process.env.UUID || '008cdf2e-5f9f-4590-9a84-8f4253c42e22'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'liang-260131';            // 获取节点的订阅路径
